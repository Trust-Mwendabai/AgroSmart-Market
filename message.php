...
// Note: Views are already included in each case statement above.
// Footer is already included in the individual view files.
// Nothing more needs to be included here to prevent duplication.
?>
