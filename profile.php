...
<style>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="literacy_level" name="literacy_level" required>
                                        ...
                                        <option value="Illiterate" <?php echo $current_user['literacy_level'] === 'Illiterate' ? 'selected' : ''; ?>>Illiterate</option>
                                        <option value="Basic" <?php echo $current_user['literacy_level'] === 'Basic' ? 'selected' : ''; ?>>Basic</option>
                                        <option value="Primary" <?php echo $current_user['literacy_level'] === 'Primary' ? 'selected' : ''; ?>>Primary</option>
                                        <option value="Secondary" <?php echo $current_user['literacy_level'] === 'Secondary' ? 'selected' : ''; ?>>Secondary</option>
                                        <option value="Tertiary" <?php echo $current_user['literacy_level'] === 'Tertiary' ? 'selected' : ''; ?>>Tertiary</option>
                                    </select>
                                </div>
                            </div>
                            <?php endif; ?>
    ...
    <div class="container mt-4">
        <div class="alert <?php echo $can_sell ? 'alert-success' : 'alert-warning'; ?>">
            <?php if ($can_sell): ?>
